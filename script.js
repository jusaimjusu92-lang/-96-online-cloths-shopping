// State
let products = JSON.parse(localStorage.getItem('96_products')) || [
    {
        id: 1,
...
function renderProducts() {
    ...
    products.forEach(product => {
        ...
        const adminActions = isAdmin ? `<button class="btn btn-secondary" onclick="deleteProduct(${product.id})" style="width:100%; margin-top:5px; color: #ff003c; border-color: #ff003c;">DELETE_ITEM</button>` : '';
...
function handleUpload(e) {
    ...
    if (fileInput.files && fileInput.files[0]) {
        ...
        reader.onload = function (e) {
            ...
            localStorage.setItem('96_products', JSON.stringify(products));
            renderProducts();
...
function toggleAdminMode() {
    if (!isAdmin) {
        ...
        if (pass === "admin96") {
            isAdmin = true;
            document.getElementById('admin-toggle').innerText = "Logout Admin";
        ...
        isAdmin = false;
        document.getElementById('admin-toggle').innerText = "Admin Login";
